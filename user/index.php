...
$your_db_connection = mysqli_connect('localhost', 'tritech1_ktb', 'Musa@abdulkadir', 'tritech1_ktb');

$userCountQuery = "SELECT COUNT(user_id) as user_count FROM users";
...
$businessCountQuery = "SELECT COUNT(business_id) as business_count FROM businesses";
$businessCountResult = $conn->query($businessCountQuery);

if ($businessCountResult) {
    $businessCountData = $businessCountResult->fetch_assoc();
    $businessCount = $businessCountData['business_count'];
} else {
    $businessCount = 0;
}
...
$totalAmountPaid = array_sum(array_column($data, 'amount_paid'));
?>


<!-- Your HTML content for the admin dashboard goes here -->
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<link rel="canonical" href="https://demo-basic.Kano Tourism Board .io/" />

	<title>Kano Tourism Board  Demo - Bootstrap 5 Admin Template</title>
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php echo $businessCount; ?></h1>
												<div class="mb-0">
													<span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i>+<?php echo $businessCount; ?></span>
										...
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php echo $userCount; ?></h1>
												<div class="mb-0">
													<span class="text-success"> <i class="mdi mdi-arrow-bottom-right"></i><?php echo $userCount; ?></span>
													<span class="text-muted">Since last week</span>
												</div>
											</div>
										</div>
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3">₦<?php echo number_format($totalAmountPaid, 2); ?></h1>
												<div class="mb-0">
